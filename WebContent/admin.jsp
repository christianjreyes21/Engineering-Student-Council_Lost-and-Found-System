			...
			<div class="container">
				...
				<div class="col-lg-6">
					...
					<br/><BR/>
						...
						<br/>
							<div class="row">
								<!-- <div class="col-lg-4"><center><img src="images/icon.png" height="150px" style="background-color:white;"></center></div> -->
								<div class="col-lg-12" style="border-bottom:0px;">
									<center>
						...
						<br/><br/><br/>
						<center><a type="button" class="button" href="LogoutAdministrator.html" class="h">LOG OUT</a></div></center>
