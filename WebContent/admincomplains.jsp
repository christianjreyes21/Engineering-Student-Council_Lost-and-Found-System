						...
						<div class="row">
							...
							<div class="col-lg-4">
								<form action="admincomplainsx.html">
									...
									<input type="text" name="search" value="${search}" style="display:inline-block; padding:5px; border-radius: 5px; color:#f5ce09; width:95%; font-size:20px; border:0px; background-image: url('glyphicons/glyphicons-search.png'); background-size: 25px 25px; background-position: right; background-repeat: no-repeat;" placeholder="Type here...">
					...
					<div class="row e">					
						...
						<table width="100%" id="table1">
							...
							<% 
								...
								while(recordFacilities.next()) {
									hasList=false;
							%>
							
								<tr>
									<td width="40%"><%=recordFacilities.getString("concernsAndComplaints")%></td>
									<td width="20%"><%=recordFacilities.getString("lastName")%>, <%=recordFacilities.getString("firstName")%> <%=recordFacilities.getString("middleName")%></td>
									<td width="15%"><%=recordFacilities.getString("studentNumber")%></td>
									<td width="10%"><%=recordFacilities.getString("yearLevelAndSection")%></td>
									<td width="15%"><a href="reply.html?complaint=<%=recordFacilities.getString("concernsAndComplaints")%>"><div class="g">REPLY</div></a></td>
								</tr>
						...
						<table width="100%" id="table3">
							...
							%>
								...
								<tr>
									...
									<td width="15%"><a href="reply.html?complaint=<%=recordServices.getString("concernsAndComplaints")%>"><div class="g">REPLY</div></a></td>
								</tr>
